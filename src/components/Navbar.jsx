export default function Navbar() {
  return (
    <header className="w-full px-8 py-6 flex justify-between items-center bg-white/95 backdrop-blur-sm sticky top-0 z-40 shadow-sm">
      <h1 className="text-2xl font-serif text-primary relative">
        L'art de la déco
